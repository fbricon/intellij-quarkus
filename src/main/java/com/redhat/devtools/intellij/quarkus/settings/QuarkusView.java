...
public class QuarkusView implements Disposable {
    ...
    private JBTextField starterApiUrlField = new JBTextField();

    public QuarkusView() {
        JComponent descriptionPanel = createDescription(null);
        JPanel settingsPanel = createSettings(descriptionPanel);
//        TitledBorder title = IdeBorderFactory.createTitledBorder(QuarkusBundle.message("quarkus.tools.title"));
//        settingsPanel.setBorder(title);
    ...
    private JPanel createSettings(JComponent description) {
        return FormBuilder.createFormBuilder()
                ...
                .addLabeledComponent(QuarkusBundle.message("quarkus.tools.starterApiUrl"), starterApiUrlField, 5)
    ...
    public String getStarterApiUrl() {
        return starterApiUrlField.getText();
    }

    public void setStarterApiUrl(String starterApiUrl) {
        starterApiUrlField.setText(starterApiUrl);
    }
